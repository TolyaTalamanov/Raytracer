...
TEST_CASE("Shading parts", "[raytracer]") {
    ...
    CheckImage("shading_parts/scene.obj", "shading_parts/scene.png", camera_opts, render_opts, "sh.png");
}
...
TEST_CASE("Classic box", "[raytracer]") {
    ...
    //CheckImage("classic_box/tmp.obj", "classic_box/first.png", camera_opts,
